...
export class TedderfieldHistoryComponent implements OnInit {
  ...
  public historyData = [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'With its secure, well-maintained infrastructure and forward-looking management, Tedderfield Airpark continues to soar as one of South Africa\'s leading airparks.'
      ],
      isExpanded: true
    }
  ]
  ...
  public togglePannel(indexToToggle: number) {
    this.historyData[indexToToggle].isExpanded = !this.historyData[indexToToggle].isExpanded;
  }
